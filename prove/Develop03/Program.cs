...
class Program
{
...

    {
       ...
       library.AddScripture(new Reference("Mathew",10,30), "But the very hairs of your head are numbered." );
       library.AddScripture(new Reference("Mathew", 10,1),"And he had called unto him his disciples, he gave them power against unclean spirits...");
       library.AddScripture(new Reference("Luke", 5, 1),"And it came to pass, that , as the people pressed upon him to heaar hear the word of God...");
