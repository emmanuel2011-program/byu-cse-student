...
class Program
{
    static void Main(string[] args)
    {
        ...
        customer1.SetCustomerAddress("23 Ghana Street offf Aminu Kano Wuse 2", "Abuja", "FCT", "Nigeria");
        ...
        customer2.SetCustomerAddress("3rd Avenue Gwarimpa", "Abuja", "Abuja", "Nigeria");
